...
# Port must track the running server (start-macos.sh: ODYSSEUS_PORT > APP_PORT
# > 7860) — a hardcoded 7000 hits macOS AirPlay Receiver, which 403s.
_COOKBOOK_BASE = "http://localhost:" + os.getenv(
    "ODYSSEUS_PORT", os.getenv("APP_PORT", "7860")
)
